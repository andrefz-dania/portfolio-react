...
export default function Card() {
  return (
    <div className="flex flex-col shadow-lg shadow-black/30 gap-4 max-w-md text-white bg-linear-to-b from-foreground1 to-foreground2 p-8 rounded-2xl border-t-3 border-white/5 hover:scale-[1.01] transition-all">
      ...
      <div className="flex flex-row gap-4 place-items-around mx-auto">
